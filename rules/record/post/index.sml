...
Require(rule='rules/record/post/follow_begging.sml')
Require(rule='rules/record/post/engagement_farming.sml')
Require(rule='rules/record/post/adult_content_spam.sml')
Require(rule='rules/record/post/cosplaying_spam_network.sml')
Require(rule='rules/record/post/recovery_scam_enhanced.sml')
Require(rule='rules/record/post/csam_solicitation_enhanced.sml')
