...
GazaSpamHandleRegistrationRule = Rule(
  ...
  description='Handle registration matches known saveabed spam pattern',
)
...
Ma7modsHandleRegistrationRule = Rule(
  ...
  description='Handle registration matches ma7mods spam pattern',
)
...
GazaNumericHandleRule = Rule(
  ...
  description='Handle matches Gaza-themed spam pattern',
)
...
WhenRules(
  ...
  then=[
    AtprotoLabel(
      ...
      comment='Handle registration matches coordinated spam campaign pattern',
